...
//----------------------------------------------------------------
//
//  QueryportofloadingbolManager
//
//----------------------------------------------------------------

public class QueryportofloadingbolManager extends DAManager 
{
 //----------------------------------------------------------------
 // Constructors
 //----------------------------------------------------------------
  public QueryportofloadingbolManager() {}  
  public QueryportofloadingbolManager(DatastoreJDBC aDatastore) {
	super(aDatastore);
  }  
  ...
  protected final DataAccessObject _newElement() {
	...
	((Queryportofloadingbol)newObject).setObjectsDatastore(getObjectsDatastore());
	return newObject;
  }  
  protected void _setBusy(boolean flag) { super._setBusy(flag); }  
  public Queryportofloadingbol element() { return (Queryportofloadingbol)_cachedObject; }  
  protected void firePropertyChange(String property, Object oldValue, Object newValue) {
	super.firePropertyChange(property, oldValue, newValue);
  }  
  public DatastoreJDBC getCurrentDatastore() {
	if (getObjectsDatastore() != null) return getObjectsDatastore();
	else if (Queryportofloadingbol.getDefaultDatastore() != null) return Queryportofloadingbol.getDefaultDatastore();
	else return DatastoreJDBC.getApplicationDatastore();
  }  
  public static String getSQLBaseQuery() { return "select distinct portofloading from ildar.BOL "; }  
  protected DataAccessObject newElement() { return new Queryportofloadingbol(); }  
  ...
  { 
	...
	try {
	  ...
	  _map = new QueryportofloadingbolMap();
	  _setOpen(true);
 ...
 //----------------------------------------------------------------
  ...
  public void setObjectsDatastore(DatastoreJDBC aDatastore) {
	...
	((Queryportofloadingbol)_cachedObject).setObjectsDatastore(aDatastore);
  }  
}
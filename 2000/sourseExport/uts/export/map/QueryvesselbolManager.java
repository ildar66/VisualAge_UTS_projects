...
//----------------------------------------------------------------
//
//  QueryvesselbolManager
//
//----------------------------------------------------------------

public class QueryvesselbolManager extends DAManager 
{
 //----------------------------------------------------------------
 // Constructors
 //----------------------------------------------------------------
  public QueryvesselbolManager() {}  
  public QueryvesselbolManager(DatastoreJDBC aDatastore) {
	super(aDatastore);
  }  
  ...
  protected final DataAccessObject _newElement() {
	...
	((Queryvesselbol)newObject).setObjectsDatastore(getObjectsDatastore());
	return newObject;
  }  
  protected void _setBusy(boolean flag) { super._setBusy(flag); }  
  public Queryvesselbol element() { return (Queryvesselbol)_cachedObject; }  
  protected void firePropertyChange(String property, Object oldValue, Object newValue) {
	super.firePropertyChange(property, oldValue, newValue);
  }  
  public DatastoreJDBC getCurrentDatastore() {
	if (getObjectsDatastore() != null) return getObjectsDatastore();
	else if (Queryvesselbol.getDefaultDatastore() != null) return Queryvesselbol.getDefaultDatastore();
	else return DatastoreJDBC.getApplicationDatastore();
  }  
  public static String getSQLBaseQuery() { return "select distinct vessel from ildar.Bol "; }  
  protected DataAccessObject newElement() { return new Queryvesselbol(); }  
 ...
 //----------------------------------------------------------------
  ...
  public void setObjectsDatastore(DatastoreJDBC aDatastore) {
	...
	((Queryvesselbol)_cachedObject).setObjectsDatastore(aDatastore);
  }  
}
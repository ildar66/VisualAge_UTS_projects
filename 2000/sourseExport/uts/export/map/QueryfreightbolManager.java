...
//----------------------------------------------------------------
//
//  QueryfreightbolManager
//
//----------------------------------------------------------------

public class QueryfreightbolManager extends DAManager 
{
 //----------------------------------------------------------------
 // Constructors
 //----------------------------------------------------------------
  public QueryfreightbolManager() {}  
  public QueryfreightbolManager(DatastoreJDBC aDatastore) {
	super(aDatastore);
  }  
  ...
  protected final DataAccessObject _newElement() {
	...
	((Queryfreightbol)newObject).setObjectsDatastore(getObjectsDatastore());
	return newObject;
  }  
  protected void _setBusy(boolean flag) { super._setBusy(flag); }  
  public Queryfreightbol element() { return (Queryfreightbol)_cachedObject; }  
  protected void firePropertyChange(String property, Object oldValue, Object newValue) {
	super.firePropertyChange(property, oldValue, newValue);
  }  
  public DatastoreJDBC getCurrentDatastore() {
	if (getObjectsDatastore() != null) return getObjectsDatastore();
	else if (Queryfreightbol.getDefaultDatastore() != null) return Queryfreightbol.getDefaultDatastore();
	else return DatastoreJDBC.getApplicationDatastore();
  }  
  public static String getSQLBaseQuery() { return "select distinct freight1 from ildar.bol "; }  
  protected DataAccessObject newElement() { return new Queryfreightbol(); }  
 ...
 //----------------------------------------------------------------
  ...
  public void setObjectsDatastore(DatastoreJDBC aDatastore) {
	...
	((Queryfreightbol)_cachedObject).setObjectsDatastore(aDatastore);
  }  
}